...
document.getElementById("verzendknop1").onclick = function WWsubmitten () {
  if (WWinput.value==="681134517") {if(confirm("Hopelijk verschijnt er deze keer wel een verrassing! Klik op Go!")){document.getElementById("video1").style.display="block"};
  }
